...
<div class="search-box active-search" ><input  type="text" name="search" id="searchId"><button class="btn-clear"><img src="./assets/images/search-clear.svg" alt=""></button></div>
