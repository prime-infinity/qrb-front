...
function AddCategory() {
  ...
  const [subCatToDel, setSubToDel] = useState(null);
  ...
  return (
    <>
      {showWarn && (
        <>
          <WarnModal
            details={mainCatToDel ? mainCatToDel : subCatToDel}
            close={removeWarn}
          />
          <PureOverlay
      ...
      <div className="row justify-content-center">
        ...
        {rest.categories?.length > 0 &&
          rest.categories.map((item, index) => (
            <div
              className="col-11 pos-rel border border-dark br-4 my-2 py-2 fs-14"
              key={index}
            >
              <div className="row">
                <div className="col-12">
                  ...
                  <span>
                    <svg
                      onClick={() =>
                        deleteMainCat({ id: item._id, name: item.name })
                      }
                      xmlns="http://www.w3.org/2000/svg"
                      ...
                      <svg
                        onClick={() =>
                          deleteSubCat({
                            id: subb._id,
                            name: subb.name,
                            main: { name: item.name, id: item._id },
                          })
                        }
                        xmlns="http://www.w3.org/2000/svg"
                        className="svg-icon  cat-icon"
